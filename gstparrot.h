...
#define PARROT_MAX_CHANNELS 2000
...
#if PARROT_BIAS
#define PARROT_RNN_FLAGS (RNN_NET_FLAG_STANDARD | PARROT_EXTRA_FLAGS)
#else
#define PARROT_RNN_FLAGS (RNN_NET_FLAG_NO_BIAS | PARROT_EXTRA_FLAGS)
#endif
