...
#define CLASSIFY_RNN_MASKS (RNN_COND_MASK_RAND | RNN_COND_MASK_OFFSET)
#if CLASSIFY_BIAS
#define CLASSIFY_RNN_FLAGS (RNN_NET_FLAG_STANDARD | CLASSIFY_RNN_MASKS)
#else
#define CLASSIFY_RNN_FLAGS (RNN_NET_FLAG_NO_BIAS | CLASSIFY_RNN_MASKS)
#endif
